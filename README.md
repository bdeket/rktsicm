...
A start for scribble documentation is made in the [documentation package](https://github.com/bdeket/rktsicm/rktsicm-doc), and can be previewed at [bdeket.github.io/rktsicm](https://bdeket.github.io/rktsicm).
...
```
Installing the documentation can be done as shown below.
```
raco pkg install git://github.com/bdeket/rktsicm/?path=rktsicm-doc
```
