...
(require (only-in "../../../rkt/glue.rkt" if make-initialized-vector subvector-fill!
                  fix:= fix:+
                  flo:< flo:> flo:+ flo:- flo:* flo:/ flo:sqrt flo:log flo:random-unit flo:truncate->exact flo:negate)
         racket/flonum
